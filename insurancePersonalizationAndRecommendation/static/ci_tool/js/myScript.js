...
function reasonChange(e) {
    if(e.currentTarget.checked && e.currentTarget.value == "coverage") {
        obejctionData.innerHTML = `<ul class="m-0">
        <li>Is your existing insurance enough to cover your debt and look after your family's immediate and long-term needs?</li>
        <li>Does your existing insurance cover both you and your co-borrower/guarantor?</li>
        <li>Have you considered if you leave your employer or lose your job, that any group coverage you have through your employer may terminate, meaning you and your family could be left without coverage?</li>
        </ul>`; 
    }
